        ...
        <div className="max-w-[1240px] mx-auto py-16 px-4 flex flex-col lg:flex-row items-center text-gray-300">
            ...
            <div className="lg:col-span-2 flex justify-center lg:justify-between mt-[16px] mx-[150px]">
                <div className="mr-20">
                    ...
                    <ul>
                        <li className="py-2 text-lg text-redirectColor"><Link to="/Documentation">Documentation</Link>
                        </li>
                        <li className="py-2 text-lg text-redirectColor"><Link to="/Documentation#api-status">API
                            Status</Link></li>
                    </ul>
                </div>
                <div className="mr-20">
                    ...
                    <ul>
                        <li className="py-2 text-lg text-redirectColor"><Link to="/About">About Us</Link></li>
                        <li className="py-2 text-lg text-redirectColor"><Link to="/Contact">Contact</Link></li>
                    </ul>
                </div>
